...
| Provider routes | Dev route DeepSeek V4-Flash through the LLM provider port, demo / eval canonical route OpenAI gpt-5.4-mini. Both routes captured in the route catalogue. |
