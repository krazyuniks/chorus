...
tasks; UC3 full fixture playback, projection evidence for a triggered local
run, the documented operator command, and live-provider activation remain
closure exceptions.
