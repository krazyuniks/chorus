...
recorded-replay model routes for the workflow agent tasks. UC2 and UC3 are
not claimed as locally runnable use cases because documented operator intake
commands, UC3 provider route activation, and full fixture playback remain
closure exceptions.
