...
inspection, and schema-only eval fixtures; UC3 local intake, use-case provider
route activation, and full fixture playback remain closure exceptions.
