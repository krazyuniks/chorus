...
| Postgres persistence, projections, and tenant isolation | [`../infrastructure/postgres/migrations/001_phase_1a_persistence_foundation.sql`](../infrastructure/postgres/migrations/001_phase_1a_persistence_foundation.sql) — tenant-scoped registry, routing, grants, read model, decision trail, audit, history, outbox, and RLS. [`../infrastructure/postgres/seeds/001_demo_tenants.sql`](../infrastructure/postgres/seeds/001_demo_tenants.sql) — two demo tenants. [`../chorus/persistence/`](../chorus/persistence/) — migration runner and read-model/projection adapter. [`../tests/persistence/test_postgres_foundation.py`](../tests/persistence/test_postgres_foundation.py) — real Postgres RLS, fail-closed, projection, and outbox checks. | Phase 1A Workstream A foundation implemented. |
