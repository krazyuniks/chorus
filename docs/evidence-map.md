...
branch, and the happy issue fixture now projects into the existing BFF/UI
inspection surfaces. The documented operator command and live-provider
activation remain closure exceptions.
