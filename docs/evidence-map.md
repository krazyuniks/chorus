...
startup credential gating is in place. OpenAI live replay activation now has
an explicit `just test-live-openai` integration gate for UC1, UC2, and UC3
happy-path captured transcripts; DeepSeek coverage and persisted live replay
rows remain closure exceptions.
