...
deterministic synthetic outputs. UC2 grants, approval/conduct invariants,
provider routes, projections, eval fixtures, and a local intake start path
remain later R4 slices. The active R4 backlog and continuation handoff are in
