...
definition-first workflow on the shared spine; runtime connector adapters,
grants, approval packages, projections, provider routes, and local intake
start paths remain later P5 work.
...
review, and close. It is not locally runnable yet because connector adapters,
grants, approval-package behaviour, projections, provider routes, eval
playback, and local intake remain later P5 slices. The active R4 backlog and
continuation handoff are in
