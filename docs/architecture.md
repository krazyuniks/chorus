...
Live-provider startup credential gating is now in place, and OpenAI plus
DeepSeek live replay activation are covered by the explicit
`just test-live-openai` and `just test-live-deepseek` integration gates. UC2
