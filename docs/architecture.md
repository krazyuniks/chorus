...
deterministic synthetic outputs. It is not locally runnable yet because grants,
approval-package behaviour, projections, provider routes, eval playback, and
local intake remain later P5 slices. The active R4 backlog and continuation
handoff are in
