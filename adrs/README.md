...
This directory contains only current architecture decisions for Chorus. It is
not a history store. If a decision stops being current, rewrite or remove it
instead of keeping superseded material beside the active design.
